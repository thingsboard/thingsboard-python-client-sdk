...
class GatewayUplinkMessageBuilder:
    ...
    def set_device_profile(self, profile: str) -> 'GatewayUplinkMessageBuilder':
        self._device_profile = profile
        if profile is not None:
            self.__size += len(profile)
        return self

    def add_attributes(self, attributes: Union[AttributeEntry, List[AttributeEntry]]) -> 'GatewayUplinkMessageBuilder':
