...
class GatewayAttributeUpdate(AttributeUpdate, BaseGatewayEvent):
    ...
    def __init__(self, device_name: str, attribute_update: Union[AttributeUpdate, List[AttributeEntry], AttributeEntry]):
        ...
        if isinstance(attribute_update, list) and all(isinstance(entry, AttributeEntry) for entry in attribute_update):
            ...
            raise TypeError("attribute_update must be an instance of AttributeUpdate, list of AttributeEntry, or a single AttributeEntry.")
