...
async def main():
    ...
    config = DeviceConfig()
    # config.host = "192.168.1.202"
    # config.access_token = "ypbn08v8f4klg6oah3r6"
    ...
    attribute_request = AttributeRequest(["uno"], ["client"])
...
if __name__ == "__main__":
    try:
        ...
        loop.set_debug(True)  # Enable debug mode for asyncio
