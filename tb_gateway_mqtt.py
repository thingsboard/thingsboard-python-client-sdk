...
warnings.warn(
    "The tb_gateway_mqtt module is deprecated and will be removed in a future version. "
    "Please use tb_mqtt_client.service.gateway.client.GatewayClient instead.",
    DeprecationWarning,
    stacklevel=2
)
