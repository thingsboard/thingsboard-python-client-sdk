...
async def test_handle_successful_rpc():
    ...
    deserialized_data = {"device": "test_device", "data": {"id": 1, "method": "test_method", "params": {"param1": "value1"}}}
...
async def test_handle_no_device_session():
    ...
    deserialized_data = {"device": "nonexistent_device", "data": {"id": 1, "method": "test_method", "params": {"param1": "value1"}}}
    message_adapter.deserialize_to_dict.return_value = deserialized_data
